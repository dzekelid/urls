...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/urls/master/_listings/predix/apis.md
...
- name: Access Control - Retrieves the resource for the given zone. The resourceIdentifier
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/urls/master/_listings/predix/v1resourceresourceidentifier-get-openapi.md
- name: Access Control - Creates/Updates a given resource for a given zone. The resourceIdentifier
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/urls/master/_listings/predix/v1resourceresourceidentifier-put-openapi.md
- name: Access Control - Deletes the resource for a given zone. The resourceIdentifier
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/urls/master/_listings/predix/v1resourceresourceidentifier-delete-openapi.md
- name: Access Control - Retrieves the subject for the given zone. The subjectIdentifier
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/urls/master/_listings/predix/v1subjectsubjectidentifier-get-openapi.md
- name: Access Control - Deletes the subject for a given zone. The subjectIdentifier
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/urls/master/_listings/predix/v1subjectsubjectidentifier-delete-openapi.md
- name: Access Control - Deletes the subject for a given zone. The subjectIdentifier
    must be URL encoded in application/x-www-form-urlencoded format with UTF-8.
  x-api-slug: v1subjectsubjectidentifier-delete
  description: Deletes the subject for a given zone. the subjectidentifier must be
